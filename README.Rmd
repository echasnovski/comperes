...
- __Summarise__:
    ...
    - Use _common item summary functions_ with [rlang](https://rlang.r-lib.org/)'s [unquoting](https://rlang.r-lib.org/reference/quasiquotation.html) mechanism. Example: `. %>% summarise_player(!!!summary_funs["mean_score"])`.
